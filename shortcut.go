...
//
//	proton.Row(win,
//	    func(win proton.Context) { proton.Label(win, "Save") },
...
//
//	proton.Row(win,
//	    func(win proton.Context) { proton.StatusDot(win, proton.RGB(0x4ade80), 10) },
//	    func(win proton.Context) { proton.Gap(win, 6) },
//	    func(win proton.Context) { proton.Caption(win, "Connected") },
//	)

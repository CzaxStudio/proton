...
func main() {
	...
	a.Window("Proton Kitchen Sink", 800, 620, func(win proton.Context) {
		draw(win, u)
	})
	a.Run()
}
...
func tabWidgets(win proton.Context, u *ui) {
	proton.Scroll(win, &u.widgetScroll, func(win proton.Context) {
		proton.LabeledDivider(win, "SelectBox")
		proton.Gap(win, 8)
		proton.MaxWidth(win, 240, func(win proton.Context) {
		...
		proton.Row(win,
			func(win proton.Context) {
				proton.Column(win,
					func(win proton.Context) { proton.Caption(win, "Quantity") },
					func(win proton.Context) { proton.Gap(win, 4) },
					func(win proton.Context) { proton.NumberInput(win, &u.qty, 1, 99, 1) },
				)
			},
			func(win proton.Context) { proton.Gap(win, 24) },
			func(win proton.Context) {
				proton.Column(win,
					func(win proton.Context) { proton.Caption(win, "Rating (0.5 steps)") },
					func(win proton.Context) { proton.Gap(win, 4) },
					func(win proton.Context) { proton.NumberInput(win, &u.rating, 0, 5, 0.5) },
				)
			},
		)
		...
		if u.selectedColor >= 0 {
			proton.Row(win,
				...
				func(win proton.Context) { proton.Gap(win, 6) },
				func(win proton.Context) {
		...
		proton.Gap(win, 6)
		proton.Accordion(win, &u.acc1, &u.acc1btn, "What is Proton?", func(win proton.Context) {
			proton.Gap(win, 4)
			proton.Label(win, "A GUI library for Go. No C deps. Just go build.")
		})
		proton.Gap(win, 2)
		proton.Accordion(win, &u.acc2, &u.acc2btn, "Does it support Windows?", func(win proton.Context) {
			proton.Gap(win, 4)
		...
		proton.Row(win, func(win proton.Context) {
			for _, s := range statuses {
				s := s
				proton.Row(win,
					func(win proton.Context) { proton.StatusDot(win, s.c, 9) },
					func(win proton.Context) { proton.Gap(win, 5) },
					func(win proton.Context) { proton.Caption(win, s.label) },
					func(win proton.Context) { proton.Gap(win, 16) },
				)
			}
		})
	})
...
func tabText(win proton.Context, u *ui) {
...
a.Run()`)
	...
	proton.Gap(win, 8)
	proton.Row(win,
		func(win proton.Context) { proton.Label(win, "Save file") },
		func(win proton.Context) { proton.Gap(win, 8) },
		func(win proton.Context) { proton.ShortcutHint(win, "Ctrl+S") },
		func(win proton.Context) { proton.Gap(win, 24) },
		func(win proton.Context) { proton.Label(win, "Undo") },
		func(win proton.Context) { proton.Gap(win, 8) },
		func(win proton.Context) { proton.ShortcutHint(win, "Ctrl+Z") },
	)
}

func tabLayout(win proton.Context, u *ui) {
	proton.LabeledDivider(win, "ResizeSplit — drag the handle")
	proton.Gap(win, 8)

	proton.MinSize(win, 0, 200, func(win proton.Context) {
	...
	proton.GrowRow(win,
		proton.FixedItem(win, func(win proton.Context) { proton.Caption(win, "pushed left") }),
		proton.FlexSpacer(),
		proton.FixedItem(win, func(win proton.Context) { proton.Caption(win, "pushed right") }),
	)
}

func tabAsync(win proton.Context, u *ui) {
	...
	proton.MinSize(win, 0, 160, func(win proton.Context) {
		proton.Card(win, proton.RGB(0x2e3440), 6, 0, func(win proton.Context) {
			proton.Pad(win, 8, func(win proton.Context) {
...
func tabOverlay(win proton.Context, u *ui) {
	...
	proton.Overlay(win, &u.modal, func(win proton.Context) {
		proton.MinSize(win, 300, 0, func(win proton.Context) {
			proton.Card(win, proton.RGB(0x2e3440), 12, 24, func(win proton.Context) {

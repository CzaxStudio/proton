...
func main() {
	...
	a.Window("Proton Showcase", 720, 560, func(win proton.Context) {
		draw(win, u)
	})
	a.Run()
}
...
func draw(win proton.Context, u *ui) {
	// top bar
	proton.PadSides(win, 0, 0, 8, 0, func(win proton.Context) {
		proton.RowSpread(win,
			func(win proton.Context) { proton.H4(win, "Proton Showcase") },
	...
	proton.Split(win, 0.45,
		func(win proton.Context) { leftPanel(win, u) },
...
func leftPanel(win proton.Context, u *ui) {
...
func rightPanel(win proton.Context, u *ui) {
	...
	proton.Card(win, proton.RGB(0x3b4252), 8, 0, func(win proton.Context) {
		proton.List(win, &u.scroll, len(u.items), func(win proton.Context, i int) {
			proton.PadV(win, 5, func(win proton.Context) {
				proton.PadH(win, 8, func(win proton.Context) {
	...
	proton.Grid(win, 3, 6,
		...
		func(win proton.Context) { proton.Badge(win, proton.RGB(0xa3be8c), proton.RGB(0x2e3440), "Pure") },
		func(win proton.Context) { proton.Badge(win, proton.RGB(0xbf616a), proton.RGB(0xeceff4), "Fast") },
	)
}
